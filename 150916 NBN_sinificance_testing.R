...
Chi2_testing <- function(the_file_name){ 
  ...
  file_saved <- paste(output_file_path , 'SigTest_' , the_file_name  , sep = '')
  ...
  sig <- rbind(sig, data.frame(Var_Name , t , Group1_TOP , Group1_BOTTOM , Group2_TOP , Group2_BOTTOM , Statistic , df , P.Value, ConSelection , FunnelStep, Country))
  }}}}
...
# source("C:\\R\\NBN_ad_hoc_analyses\\R_scripts\\150916 NBN_sinificance_testing.r")
################################################################################################################